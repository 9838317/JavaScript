...
**/
var rectangle_hashlzf = {};

    //to return a random color value of #??????
    rectangle_hashlzf.randomColor = 
    ...
    rectangle_hashlzf.generateMother = 

        function(width, height)
        {
            var divMother                       = document.createElement("div");
                divMother.id                    = "divMother";
                divMother.style.width           = width;
                divMother.style.height          = height;
                divMother.style.backgroundColor = this.randomColor();
    ...
    rectangle_hashlzf.formatObject = 
    ...
    rectangle_hashlzf.generateSingleDiv = 
